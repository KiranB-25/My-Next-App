...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen w-full flex items-center justify-center px-4 py-12 md:px-20 bg-gradient-to-br from-white via-gray-100 to-slate-200 dark:from-[#0f051d] dark:via-[#110827] dark:to-[#030014] transition-colors"
    >
        ...
        <div>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://calendly.com/kiranbukhari588/discuss-your-project-with-kiran",
                  "_blank"
                )
              }
            >
